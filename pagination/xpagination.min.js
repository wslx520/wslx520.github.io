    ...
    ui.Pagination = core.inherits(
        ...
        },
        {
            ...
            go: function (page) {
                ...
                if (page !== 1) {
                    dom.removeClass(pageList[0].previousSibling, pageDisable);
                    if (page === pages) {
                        setActive(pageList[pl - 1]);
                        dom.addClass(pageList[pl - 1].nextSibling, pageDisable);
                    } else {
                        dom.removeClass(pageList[pl - 1].nextSibling, pageDisable);
                    }
                } else {
                    setActive(pageList[0]);
                    dom.addClass(pageList[0].previousSibling, pageDisable);
                }
                if (root.jump) {
